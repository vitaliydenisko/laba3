...
am_program_OBJECTS = funca.$(OBJEXT) main.$(OBJEXT)
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(top_srcdir)/debian/control.in README.md compile depcomp \
	install-sh missing
...
top_builddir = .
top_srcdir = .
program_SOURCES = funca.cpp funca.h main.cpp
test_SOURCES = test.cpp funca.cpp funca.h
all: all-am
